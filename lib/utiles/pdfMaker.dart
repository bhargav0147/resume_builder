              ...
              pw.Column(
                ...
                children: [
                     pw.Container(
                      ...
                      decoration:
                      pw.BoxDecoration(color: PdfColors.blueGrey200),
                      child: pw.Column(
                        crossAxisAlignment: pw.CrossAxisAlignment.start,
                        children: [
                          ...
                          pw.Padding(
                            ...
                            child: pw.ClipOval(
                              child : pw.Image(pw.MemoryImage(File("${d1.photoPath}").readAsBytesSync())),
                            ),
                          ),
                          pw.SizedBox(height: 60),
                          pw.Padding(
                          ...
                          pw.Align(
                            ...
                            child: pw.Padding(
                                padding: const pw.EdgeInsets.symmetric(
                                    horizontal: 15),
                                child: pw.Text(
                                  "${d1.rangeValues?.start.toInt()} - ${d1.rangeValues?.end.toInt()}",
                                  style: pw.TextStyle(
                                      color: PdfColors.black,
                                      letterSpacing: 1,
                                      fontSize: 15),
